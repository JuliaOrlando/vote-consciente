...
const toneClasses: Record<Tone, string> = {
  primary:
    "bg-[color:var(--accent-soft)] text-[color:var(--accent-strong)] border-[color:rgba(15,118,110,0.18)]",
  neutral:
    "bg-[color:rgba(255,255,255,0.82)] text-[color:var(--ink-muted)] border-[color:var(--border)]",
  success:
    "bg-[color:rgba(12,141,103,0.12)] text-[color:var(--success-ink)] border-[color:rgba(12,141,103,0.18)]",
  warning:
    "bg-[color:rgba(184,106,28,0.12)] text-[color:var(--warning-ink)] border-[color:rgba(184,106,28,0.18)]",
  danger:
    "bg-[color:rgba(176,57,38,0.12)] text-[color:var(--danger-ink)] border-[color:rgba(176,57,38,0.18)]",
};
...
export function buttonStyles({
  ...
  return cn(
    "inline-flex items-center justify-center gap-2 rounded-full font-semibold transition-all focus-visible:outline-none focus-visible:ring-4 focus-visible:ring-[color:var(--focus-ring)] disabled:pointer-events-none disabled:opacity-60",
    size === "sm" && "min-h-10 px-4 text-sm",
    size === "md" && "min-h-11 px-5 text-sm",
    size === "lg" && "min-h-12 px-6 text-base",
    variant === "primary" &&
      "bg-[color:var(--accent)] text-white shadow-[0_18px_40px_-24px_rgba(15,118,110,0.7)] hover:bg-[color:var(--accent-strong)]",
    variant === "secondary" &&
      "border border-[color:var(--border)] bg-white/80 text-[color:var(--ink)] hover:border-[color:var(--border-strong)] hover:bg-white",
    variant === "ghost" &&
...
export function MetricTile({
  ...
  return (
    <div className={cn("vc-panel flex h-full flex-col gap-3", className)}>
...
export function EmptyState({
  ...
  return (
    <SurfaceCard className={cn("flex flex-col items-start gap-4 p-6 sm:p-8", className)}>
      {Icon ? (
        <span className="flex h-12 w-12 items-center justify-center rounded-2xl bg-[color:var(--accent-soft)] text-[color:var(--accent-strong)]">
